...
export class PassApiService extends BaseService {
  constructor(
  ...
  /**
   * Path part for operation apiPassCodeGet
   */
  static readonly ApiPassCodeGetPath = '/api/Pass/{code}';
  ...
  activate$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, PassApiService.ApiPassCodeGetPath, 'get');
    if (params) {
